export const data = {
  ...
  artists: {
    cn: [
      { name: "何遠良", src: "/HoYuenLeung" },
      { name: "管偉邦", src: "/KoonWaiBong" },
      { name: "林東鵬", src: "/LamTungPang" },
      { name: "梁嘉賢", src: "/LeungKaYin" },
      { name: "黃進曦", src: "/WongChunHei" },
      { name: "黃麗貞", src: "/WongLaiChing" },
    ],
    en: [
      { name: "Ho Yuen Leung", src: "/HoYuenLeung" },
      { name: "Koon Wai Bong", src: "/KoonWaiBong" },
      { name: "Lam Tung Pang", src: "/LamTungPang" },
      { name: "Leung Ka Yin, Joey", src: "/LeungKaYin" },
      { name: "Wong Chun Hei, Stephen", src: "/WongChunHei" },
      { name: "Wong Lai Ching, Fiona", src: "/WongLaiChing" },
    ],
  },
  curator: {
    cn: ["丁穎茵"],
